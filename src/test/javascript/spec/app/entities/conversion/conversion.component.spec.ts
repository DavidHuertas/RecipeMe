...
import { ConversionComponent } from 'app/entities/conversion/conversion.component';
...
describe('Component Tests', () => {
  describe('Conversion Management Component', () => {
    let comp: ConversionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ConversionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.conversions && comp.conversions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
