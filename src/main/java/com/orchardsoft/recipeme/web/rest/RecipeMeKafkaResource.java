...
@RestController
@RequestMapping("/api/recipe-me-kafka")
public class RecipeMeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RecipeMeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RecipeMeKafkaResource(KafkaProperties kafkaProperties) {
