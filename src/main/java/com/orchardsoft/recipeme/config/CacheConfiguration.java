package com.orchardsoft.recipeme.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.orchardsoft.recipeme.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.orchardsoft.recipeme.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.orchardsoft.recipeme.domain.Recipe.class.getName() + ".ingredients");
