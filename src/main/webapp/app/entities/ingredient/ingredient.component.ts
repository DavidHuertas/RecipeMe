...
export class IngredientComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    if (this.currentSearch) {
      this.ingredientService
        ...
        .subscribe((res: HttpResponse<IIngredient[]>) => this.paginateIngredients(res.body, res.headers));
      return;
    }
    this.ingredientService
      .query({
  ...
  registerChangeInIngredients(): void {
    this.eventSubscriber = this.eventManager.subscribe('ingredientListModification', () => this.reset());
  }
